...
namespace BackendAwSmartstay.API.Migrations
{
    ...
    [Migration("20260918080256_RoomStatusHistoryAndMaintenanceAlerts")]
    partial class RoomStatusHistoryAndMaintenanceAlerts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackendAwSmartstay.API.Accommodations.Domain.Model.Aggregates.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoomTypeId = 1,
                            Status = "Available",
                            StatusChangedAt = new DateTimeOffset(new DateTime(2026, 9, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 102,
